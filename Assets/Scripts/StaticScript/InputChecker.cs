...
public static class InputChecker
{
    ...
    /// </summary>
    /// <param name="_field">읽어올 TMP_InputField</param>
    /// <param name="_includeZero">0을 포함할지의 여부</param>
    /// <returns>양의 실수 여부 반환.</returns>
    public static bool IsNeagtiveFloat(TMP_InputField _field, bool _includeZero = false)
    {
    ...
    public static bool IsPositiveFloat(TMP_InputField _field, bool _includeZero = false) {
    ...
    public static float GetFloat(TMP_InputField _field)
    {
